...
public class SoftwareTest {
	...
	{ 
		...
		int indexToGet = consoleFake.linesDisplayed.size() - (4 + (MazeCreator.NUMBER_OF_ROWS * 3));// -1 car, size débute à 1, tandis que les index commencent à 0, -1 car le message Welcome_message est toujours affiché à la fin. Donc -2.
   ...
   {   
       ...
       int indexToGet = consoleFake.linesDisplayed.size() - 63; // -1 car, size débute à 1, tandis que les index commencent à 0, -1 car le message Welcome_message est toujours affiché à la fin. Donc -2.
	...
	{ 
		...
		final String EXPECTED_VALUE = "Est-ce que j'aurai un autre labyrinthe1?";
		int indexToGet = consoleFake.linesDisplayed.size() - (3 + (MazeCreator.NUMBER_OF_ROWS * 2));// -1 car, size débute à 1, tandis que les index commencent à 0, -1 car le message Welcome_message est toujours affiché à la fin. Donc -2.
																							  // - 20 (ou MazeCreator.NUMBER_OF_ROWS) pour faire abstraction du labyrinthe.
		final String ACTUAL_VALUE = consoleFake.linesDisplayed.get(indexToGet);
		assertEquals(EXPECTED_VALUE, ACTUAL_VALUE);
    ...
    {   
        ...
        int indexToGet = consoleFake.linesDisplayed.size() - 42; // -1 car, size débute à 1, tandis que les index commencent à 0, -1 car le message Welcome_message est toujours affiché à la fin. Donc -2.
    ...
    @Test
   	...
   	{ 
   		...
   		final String EXPECTED_VALUE = "Est-ce que j'aurai un autre labyrinthe2?";
   		int indexToGet = consoleFake.linesDisplayed.size() - (2 + (MazeCreator.NUMBER_OF_ROWS * 1));// -1 car, size débute à 1, tandis que les index commencent à 0, -1 car le message Welcome_message est toujours affiché à la fin. Donc -2.
   																							  // - 20 (ou MazeCreator.NUMBER_OF_ROWS) pour faire abstraction du labyrinthe.
   		final String ACTUAL_VALUE = consoleFake.linesDisplayed.get(indexToGet);
   		assertEquals(EXPECTED_VALUE, ACTUAL_VALUE);
   	}
    ...
    {   
        ...
        int indexToGet = consoleFake.linesDisplayed.size() - 21; // -1 car, size débute à 1, tandis que les index commencent à 0, -1 car le message Welcome_message est toujours affiché à la fin. Donc -2.
