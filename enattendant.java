...
public class SoftwareTest {
   ...
   {   
    ...
    {   
        ...
        int indexToGet = consoleFake.linesDisplayed.size() - 20; // -1 car, size débute à 1, tandis que les index commencent à 0, -1 car le message Welcome_message est toujours affiché à la fin. Donc -2.
